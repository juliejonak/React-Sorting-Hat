...
const Q1 = (props) => {
    return (
        <div className={props.q1 ? 'q1' : 'hidden'}>
            ...
            <button className="quiz-button answer-one" onClick={props.logHufflepuff} >
                Prepare? I just handle it as it happens.
            </button>
            <button className="quiz-button answer-two" onClick={props.logRavenclaw} >
                I make a detailed schedule.
            </button>
            <button className="quiz-button answer-three" onClick={props.logGryffindor} >
                I usually wait until last minute...but it all gets done.
            </button>
            <button className="quiz-button answer-four" onClick={props.logSlytherin} >
